...
const BrochureSection = () => {
  return (
    <section id="brochure" className="py-16 md:py-24 bg-background overflow-hidden">
          ...
          <div className="relative">
            ...
            <Card className="relative z-10 border-8 border-secondary rounded-2xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
              <CardContent className="p-0">
                <Image
                  src="https://picsum.photos/seed/brochure/800/1100"
                  alt="EZCirkit Brochure Cover"
                  width={800}
                  height={1100}
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-foreground/70 leading-relaxed">
                Download our detailed 4-page brochure to explore every component, circuit diagram, and project included in the EZCirkit Educational Starter Kit. 
              </p>
            </div>

            <ul className="space-y-4">
              {[
                'Full Component List & Specifications',
                'Curriculum & Project Roadmap',
                'Learning Outcomes for Students',
                'Exclusive "Inventors" Discount Code'
              ].map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                  <div className="h-6 w-6 rounded-full bg-green/10 flex items-center justify-center text-green">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button size="lg" className="bg-primary-gradient shadow-lg" asChild>
                <a href="/brochure.pdf" download>
                  <Download className="mr-2 h-5 w-5" /> Download PDF (2.4MB)
                </a>
              </Button>
